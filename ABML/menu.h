...
void listado_profesor()            // menu profesores
{
    bool salir = true;
    int opcion;

    // Titulo del menú y nombres de las opciones
    const char *titulo = "MENU LISTADOS";    // LAS OPCIONES EN EL MENU MELAS MUESTRA LA UNCION MENU,Y LE PASO LOS DATOS POR REERENCIA
    const char *opciones[] = {"LISTADOS DE PROFESORES TODOS", "LISTADOS DE PROFESORES ACTIVOS", "LISTAR TODOS LOS PROFESORES ELIMINADOS","SALIR"};  // PARA CAMBIAR LAS OPCIONES DEL MENU HAY QUE CAMBIAR ESTO DE ACA
    int n = 4;  // NUMERO DE OPCIONES QUE TIENE CADA SUBMENU
    ...
    while(salir)    // MIENTAS NO SE INGRESE ENTER EL PROGRAMA SE UEDA DANDO VUELTAS EN EL WHILE
    {
        ...
        {
        case 1:
            listado_profesor_todos();
            break;


        case 2:
             listado_profesor_activos();
            break;

        case 3:
            listado_profesor_eliminados();
            break;
...
void listado_alumno()            // menu alumno
{
    bool salir = true;
    int opcion;
    ...
    // Titulo del menú y nombres de las opciones
    const char *titulo = "MENU LISTADOS";    // LAS OPCIONES EN EL MENU MELAS MUESTRA LA UNCION MENU,Y LE PASO LOS DATOS POR REERENCIA
    const char *opciones[] = {"LISTADOS DE ALUMNO TODOS", "LISTADOS DE ALUMNO ACTIVOS", "LISTAR TODOS LOS ALUMNO ELIMINADOS","SALIR"};  // PARA CAMBIAR LAS OPCIONES DEL MENU HAY QUE CAMBIAR ESTO DE ACA
    int n = 4;  // NUMERO DE OPCIONES QUE TIENE CADA SUBMENU
    ...
    while(salir)    // MIENTAS NO SE INGRESE ENTER EL PROGRAMA SE UEDA DANDO VUELTAS EN EL WHILE
    {
        ...
        {
        case 1:
            listado_alumno_todos();
            break;


        case 2:
             listado_alumno_activos();
            break;

        case 3:
            listado_alumno_eliminados();
            break;
...
void menu_deportes()            // MENU ALUMNOS
{
    ...
    const char *opciones[] = {"FUTBOOL", "BASQUET", "TENIS", "NATACION", "HOCKEY", "SALIR"};  // PARA CAMBIAR LAS OPCIONES DEL MENU HAY QUE CAMBIAR ESTO DE ACA
    int n = 6;  // NUMERO DE OPCIONES QUE TIENE CADA SUBMENU
